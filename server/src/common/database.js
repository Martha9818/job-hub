...
async function initDatabase() {
  ...
  if (jobCount[0].count === 0) {
    const sampleJobs = [
      ...
      ['j15', 'boss', 'boss_007', '注塑模具设计助理（应届）', '立讯精密', 7000, 12000, '7K-12K', '苏州', '模具设计', '机械', '应届生', '大专', '协助注塑模具3D设计，学习模具结构设计要点', '模具设计专业，了解UG基本操作', '五险一金、年终奖、带薪年假', '全职', '2026-04-22', 'https://www.luxshare.com'],
      ...
      ['j38', '51job', '51_005', '生产计划员（机械方向-应届）', '三花控股', 6000, 10000, '6K-10K', '杭州', '生产管理', '机械', '应届生', '本科', '协助制定生产计划，跟踪生产进度与物料协调', '工业工程/机械专业，逻辑清晰，Excel熟练', '五险一金、绩效奖金、带薪年假', '全职', '2026-04-22', 'https://www.sanhua.com'],
      ...
      ['j51', 'boss', 'boss_022', '注塑模具高级设计师', '立讯精密', 16000, 26000, '16K-26K', '苏州', '模具设计', '机械', '5-10年', '大专', '负责精密注塑模具的全流程设计与技术攻关', '5年以上注塑模具设计经验，精通UG', '五险一金、年终奖、带薪年假', '全职', '2026-04-20', 'https://www.luxshare.com'],
      ...
      ['j65', 'liepin', 'lp_intern_01', '模具设计实习生', '立讯精密', 3500, 5000, '3.5K-5K', '苏州', '模具设计', '机械', '实习', '大专', '协助模具设计师完成3D建模和出图', '模具设计专业，了解UG基本操作', '实习津贴、餐补、转正机会', '实习', '2026-04-24', 'https://www.luxshare.com'],
