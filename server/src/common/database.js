...
async function initDatabase() {
  ...
  if (jobCount[0].count === 0) {
    const sampleJobs = [
      ...
      // ====== 实习岗位（20条）======
      ['j61', 'boss', 'boss_intern_01', '机械设计实习生', '三一重工股份有限公司', 4000, 6000, '4K-6K', '上海', '机械设计', '机械', '实习', '本科', '协助工程师完成机械零部件3D建模与工程图绘制', '机械专业大三/大四，会SolidWorks，每周出勤4天以上', '实习津贴、免费三餐、转正机会', '实习', '2026-04-24', 'https://www.zhipin.com/job_detail/intern_01'],
      ['j62', 'boss', 'boss_intern_02', '结构设计实习生', '大疆创新', 5000, 8000, '5K-8K', '深圳', '结构设计', '机械', '实习', '本科', '参与无人机产品结构设计验证，协助做公差分析与样品测试', '机械/力学专业，熟练CAD，有竞赛经验优先', '实习津贴、弹性工作、转正机会', '实习', '2026-04-23', 'https://www.zhipin.com/job_detail/intern_02'],
      ['j63', 'zhilian', 'zl_intern_01', '仿真分析实习生', '西门子中国', 5000, 8000, '5K-8K', '北京', '仿真分析', '机械', '实习', '硕士', '协助完成CAE仿真建模与结果后处理', '力学/机械硕士在读，会用ANSYS/Abaqus', '实习津贴、补充医疗、转正机会', '实习', '2026-04-22', 'https://www.zhaopin.com/jobs/intern_01'],
      ['j64', 'boss', 'boss_intern_03', '新能源汽车结构实习', '蔚来汽车', 5000, 7000, '5K-7K', '合肥', '汽车', '机械', '实习', '硕士', '参与电池包结构设计与轻量化方案协助', '车辆工程硕士在读，了解CATIA', '实习津贴、工作餐、转正机会', '实习', '2026-04-23', 'https://www.zhipin.com/job_detail/intern_03'],
      ['j65', 'liepin', 'lp_intern_01', '模具设计实习生', '立讯精密', 3500, 5000, '3.5K-5K', '苏州', '模具设计', '机械', '实习', '大专', '协助模具设计师完成3D建模和出图', '模具设计专业，了解UG基本操作', '实习津贴、餐补、转正机会', '实习', '2026-04-24', 'https://www.liepin.com/job/intern_01'],
      ['j66', '51job', '51_intern_01', '工艺工程实习生', '格力电器', 3000, 5000, '3K-5K', '珠海', '机械工艺', '机械', '实习', '本科', '协助编制生产工艺文件，参与工装夹具设计', '机械制造专业，了解CAD基础', '实习津贴、免费住宿、转正机会', '实习', '2026-04-22', 'https://www.51job.com/job/intern_01'],
      ['j67', 'boss', 'boss_intern_04', '半导体设备机械实习', '北方华创', 5000, 8000, '5K-8K', '北京', '半导体设备', '机械', '实习', '硕士', '参与半导体设备精密机械结构的设计与仿真', '精密机械/仪器科学硕士在读', '实习津贴、股票期权、转正机会', '实习', '2026-04-21', 'https://www.zhipin.com/job_detail/intern_04'],
      ['j68', 'zhilian', 'zl_intern_02', '机器人算法实习', '发那科机器人', 4000, 6000, '4K-6K', '上海', '机器人', '机械', '实习', '硕士', '协助工业机器人运动学建模与轨迹规划', '自动化/机器人硕士在读，了解ROS优先', '实习津贴、培训机会、转正机会', '实习', '2026-04-23', 'https://www.zhaopin.com/jobs/intern_02'],
      ['j69', 'boss', 'boss_intern_05', 'NVH分析实习生', '宁德时代', 5000, 7000, '5K-7K', '宁德', 'NVH', '机械', '实习', '硕士', '参与电池包NVH测试与数据分析', '力学/声学硕士在读，了解模态分析', '实习津贴、人才公寓、转正机会', '实习', '2026-04-22', 'https://www.zhipin.com/job_detail/intern_05'],
      ['j70', 'liepin', 'lp_intern_02', '自动化设备设计实习', '大族激光', 4000, 6000, '4K-6K', '深圳', '自动化', '机械', '实习', '本科', '协助非标自动化设备机械结构设计', '机械/自动化专业，会SolidWorks', '实习津贴、弹性工作、转正机会', '实习', '2026-04-24', 'https://www.liepin.com/job/intern_02'],
      ['j71', 'boss', 'boss_intern_06', '智能制造实习工程师', '小米汽车', 5000, 8000, '5K-8K', '北京', '智能制造', '机械', '实习', '硕士', '参与智能工厂产线规划与MES系统对接', '工业工程/机械硕士在读', '实习津贴、股票期权、转正机会', '实习', '2026-04-21', 'https://www.zhipin.com/job_detail/intern_06'],
      ['j72', '51job', '51_intern_02', 'CNC编程实习生', '大连机床集团', 3000, 4500, '3K-4.5K', '大连', '数控', '机械', '实习', '大专', '学习数控编程基础，协助简单零件加工程序编制', '数控技术专业，了解FANUC系统', '实习津贴、免费工作餐、转正机会', '实习', '2026-04-23', 'https://www.51job.com/job/intern_02'],
      ['j73', 'zhilian', 'zl_intern_03', '液压系统设计实习', '博世力士乐', 4000, 6000, '4K-6K', '上海', '液压', '机械', '实习', '本科', '协助液压回路设计与元件选型', '流体力学/液压专业，了解基本原理', '实习津贴、补充医疗、转正机会', '实习', '2026-04-22', 'https://www.zhaopin.com/jobs/intern_03'],
      ['j74', 'boss', 'boss_intern_07', '车辆动力学仿真实习', '理想汽车', 5000, 8000, '5K-8K', '常州', '车辆动力学', '机械', '实习', '硕士', '协助悬架系统动力学仿真与参数调校', '车辆工程硕士在读，了解ADAMS', '实习津贴、股票期权、转正机会', '实习', '2026-04-20', 'https://www.zhipin.com/job_detail/intern_07'],
      ['j75', 'liepin', 'lp_intern_03', '铸造工艺实习生', '潍柴动力', 3000, 5000, '3K-5K', '潍坊', '铸造', '机械', '实习', '本科', '协助铸造工艺试验与数据采集', '材料成型专业，了解砂铸基础', '实习津贴、员工宿舍、转正机会', '实习', '2026-04-21', 'https://www.liepin.com/job/intern_03'],
      ['j76', 'boss', 'boss_intern_08', '3D打印工艺实习', '先临三维', 3500, 5500, '3.5K-5.5K', '杭州', '增材制造', '机械', '实习', '本科', '协助3D打印设备工艺参数调试与样品制作', '机械/材料专业，了解增材制造原理', '实习津贴、弹性工作、转正机会', '实习', '2026-04-22', 'https://www.zhipin.com/job_detail/intern_04'],
      ['j77', 'zhilian', 'zl_intern_04', '热处理工艺实习生', '中国兵装集团', 3000, 5000, '3K-5K', '重庆', '热处理', '机械', '实习', '本科', '协助零件热处理工艺操作与金相观察', '材料科学专业，了解热处理基础', '实习津贴、员工宿舍、转正机会', '实习', '2026-04-23', 'https://www.zhaopin.com/jobs/intern_04'],
      ['j78', '51job', '51_intern_03', '质量检测实习生', '海尔集团', 3000, 4500, '3K-4.5K', '青岛', '质量管理', '机械', '实习', '大专', '协助机械零部件尺寸检测与质量记录', '机械/检测专业，细心负责', '实习津贴、员工宿舍、转正机会', '实习', '2026-04-24', 'https://www.51job.com/job/intern_03'],
      ['j79', 'mechanical-cn', 'mc_intern_01', '机械技术支持实习', '山推股份', 3000, 4500, '3K-4.5K', '济宁', '技术支持', '机械', '实习', '本科', '协助客户技术支持工作，整理故障案例', '机械专业，沟通能力好', '实习津贴、出差补贴、转正机会', '实习', '2026-04-22', 'https://www.mechanical.com.cn/job/intern_01'],
      ['j80', 'boss', 'boss_intern_09', '工业设计实习生', '大华股份', 4000, 6000, '4K-6K', '杭州', '工业设计', '机械', '实习', '本科', '参与安防设备外观造型设计与渲染出图', '工业设计专业，会用Rhino/KeyShot', '实习津贴、餐补、转正机会', '实习', '2026-04-21', 'https://www.zhipin.com/job_detail/intern_09'],
    ];
