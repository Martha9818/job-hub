const COMPANIES = [
  ...
  ['中国中车', 'https://www.crrcgc.cc', '株洲'],
  ['中国船舶集团', 'https://www.cssc.net.cn', '上海'],
  ['中国一拖集团', 'https://www.yituo.com.cn', '洛阳'],
  ['中国建筑集团', 'https://www.cscec.com', '北京'],
  ['中国兵装集团', 'https://www.csgc.com.cn', '重庆'],
  ['宝钢股份', 'https://www.baosteel.com', '上海'],
  ['潍柴动力', 'https://www.weichaipower.com', '潍坊'],
  ['山推股份', 'https://www.shantui.com', '济宁'],
  ['华为终端', 'https://www.huawei.com', '东莞'],
  ['大疆创新', 'https://www.dji.com', '深圳'],
  ['小米汽车', 'https://www.xiaomi.com', '北京'],
  ['蔚来汽车', 'https://www.nio.com', '合肥'],
  ['理想汽车', 'https://www.lixiang.com', '常州'],
  ['宁德时代', 'https://www.catl.com', '宁德'],
  ['比亚迪股份有限公司', 'https://www.byd.com', '深圳'],
  ['海康威视', 'https://www.hikvision.com', '杭州'],
  ['大华股份', 'https://www.dahuatech.com', '杭州'],
  ['立讯精密', 'https://www.luxshare-ict.com', '苏州'],
  ['北方华创', 'https://www.naura.com', '北京'],
];

const ROLES = [
  ['机械结构工程师', '结构设计', '负责机械结构方案设计、零部件选型、三维建模和工程图输出。', '熟练使用 SolidWorks 或 AutoCAD，理解机械原理和公差配合。'],
  ...
  ['模具设计工程师', '模具设计', '负责注塑或冲压模具结构设计、试模问题分析和设计优化。', '熟悉 UG 或 Creo，了解模具加工和成型工艺。'],
  ['数控编程工程师', '数控', '负责 CNC 加工程序编制、刀具路径优化和加工质量提升。', '熟悉 FANUC 或西门子系统，能阅读机械图纸。'],
  ['质量工程师', '质量管理', '负责机械零部件质量检验、问题闭环和质量体系推进。', '了解 ISO9001、8D、SPC，沟通协调能力好。'],
  ['CAE 仿真工程师', '仿真分析', '负责结构强度、模态、热分析等仿真建模和结果评估。', '熟悉 ANSYS 或 Abaqus，力学基础扎实。'],
  ['机器人应用工程师', '机器人', '负责工业机器人应用方案、夹具设计和现场调试支持。', '了解 FANUC 或 KUKA，具备自动化项目经验。'],
  ['智能制造工程师', '智能制造', '参与产线规划、设备联网、MES 对接和效率提升项目。', '了解智能工厂、数据采集和生产管理流程。'],
  ['设备维护工程师', '设备维护', '负责生产设备点检、预防性维护、故障排查和备件管理。', '机电基础扎实，能适应现场问题处理。'],
  ['机械设计实习生', '机械设计', '协助工程师完成建模、出图、样件测试和资料整理。', '机械相关专业在读，熟悉 CAD 软件，每周可稳定出勤。'],
];
